...
//	Excitation_recoil = 7787 * CLHEP::keV; tau = 1; //half-life in fs // 23Mg
...
//	Excitation_recoil = 6392.0531*CLHEP::keV; // E high an annoying mean-max correction in EMG function
	...
	{
		costheta_p1 = CLHEP::RandFlat::shoot(0.71, 1.0); // alpha particles emitted at forward angles along z-axis. starting point!
