...
void ExG4SD::Initialize(G4HCofThisEvent* hce)//invoked at the beginning of each event.
{
...
G4bool ExG4SD::ProcessHits(G4Step* step, G4TouchableHistory*)//invoked by G4SteppingManager when a step takes place
{
